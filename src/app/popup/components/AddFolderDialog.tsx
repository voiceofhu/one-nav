...
export function AddFolderDialog({
  ...
  return (
    <Drawer open={open} onOpenChange={onOpenChange}>
      <DrawerContent className="sm:max-w-lg overflow-hidden border border-white/30 bg-white/80 shadow-2xl backdrop-blur-xl dark:border-white/10 dark:bg-slate-950/80">
        <Form {...form}>
